...
export class InitSchema1750961778199 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "agency" ("id" SERIAL PRIMARY KEY NOT NULL, "name" varchar NOT NULL)`);
        await queryRunner.query(`CREATE TABLE "property" ("id" SERIAL PRIMARY KEY NOT NULL, "title" varchar NOT NULL, "description" text NOT NULL, "address" varchar NOT NULL, "price" decimal NOT NULL, "area" float NOT NULL, "bedrooms" integer NOT NULL, "bathrooms" integer NOT NULL, "floor" integer, "totalFloors" integer, "type" varchar, "status" varchar, "photos" text, "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "updatedAt" datetime, "agentId" integer, "agencyId" integer)`);
        await queryRunner.query(`CREATE TABLE "client" ("id" SERIAL PRIMARY KEY NOT NULL, "name" varchar NOT NULL, "email" varchar NOT NULL, "phone" varchar NOT NULL, "status" varchar CHECK( "status" IN ('new','negotiation','contract','deposit','success','refused') ) NOT NULL DEFAULT 'new', "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "updatedAt" datetime, "agentId" integer)`);
        await queryRunner.query(`CREATE TABLE "user" ("id" SERIAL PRIMARY KEY NOT NULL, "email" varchar NOT NULL, "password" varchar NOT NULL, "firstName" varchar NOT NULL, "lastName" varchar NOT NULL, "photo" varchar, "phone" varchar, "city" varchar, "region" varchar, "role" varchar NOT NULL DEFAULT 'agent', "agencyId" integer, "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "updatedAt" datetime)`);
        ...
        await queryRunner.query(`CREATE TABLE "notifications" ("id" SERIAL PRIMARY KEY NOT NULL, "userId" integer NOT NULL, "type" varchar NOT NULL DEFAULT ('info'), "category" varchar NOT NULL DEFAULT ('property'), "title" varchar NOT NULL, "description" varchar, "isNew" boolean NOT NULL DEFAULT (1), "createdAt" datetime NOT NULL DEFAULT (CURRENT_TIMESTAMP))`);
        await queryRunner.query(`CREATE TABLE "user_notification_settings" ("id" SERIAL PRIMARY KEY NOT NULL, "userId" integer NOT NULL, "property" boolean NOT NULL DEFAULT (1), "education" boolean NOT NULL DEFAULT (1), "system" boolean NOT NULL DEFAULT (1), CONSTRAINT "UQ_984f3e1d8fe9c03831b20b8d7a4" UNIQUE ("userId"))`);
        ...
        await queryRunner.query(`CREATE TABLE "selections" ("id" SERIAL PRIMARY KEY NOT NULL, "title" varchar NOT NULL, "propertyIds" text NOT NULL, "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "userId" integer)`);
        await queryRunner.query(`CREATE TABLE "calendar_events" ("id" SERIAL PRIMARY KEY NOT NULL, "title" varchar NOT NULL, "description" text, "start" datetime NOT NULL, "end" datetime, "type" varchar NOT NULL DEFAULT ('personal'), "userId" integer, "relatedObjectId" integer, "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "updatedAt" datetime NOT NULL DEFAULT (datetime('now')))`);
        ...
        await queryRunner.query(`CREATE TABLE "temporary_property" ("id" SERIAL PRIMARY KEY NOT NULL, "title" varchar NOT NULL, "description" text NOT NULL, "address" varchar NOT NULL, "price" decimal NOT NULL, "area" float NOT NULL, "bedrooms" integer NOT NULL, "bathrooms" integer NOT NULL, "status" varchar CHECK( "status" IN ('for_sale','in_deal','reserved','sold') ) NOT NULL DEFAULT ('for_sale'), "isExclusive" boolean NOT NULL DEFAULT (0), "photos" text, "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "lat" float, "lng" float, "agentId" integer, CONSTRAINT "FK_3df22387cc25ecbbe851a57fd32" FOREIGN KEY ("agentId") REFERENCES "user" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION)`);
        ...
        await queryRunner.query(`CREATE TABLE "temporary_client" ("id" SERIAL PRIMARY KEY NOT NULL, "name" varchar NOT NULL, "email" varchar NOT NULL, "phone" varchar NOT NULL, "status" varchar CHECK( "status" IN ('new','negotiation','contract','deposit','success','refused') ) NOT NULL DEFAULT ('new'), "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "updatedAt" datetime NOT NULL DEFAULT (datetime('now')), "agentId" integer, CONSTRAINT "UQ_6436cc6b79593760b9ef921ef12" UNIQUE ("email"), CONSTRAINT "FK_626d76371510025cccd6c0ff75d" FOREIGN KEY ("agentId") REFERENCES "user" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION)`);
        ...
        await queryRunner.query(`CREATE TABLE "temporary_user" ("id" SERIAL PRIMARY KEY NOT NULL, "email" varchar NOT NULL, "password" varchar NOT NULL, "firstName" varchar NOT NULL, "lastName" varchar NOT NULL, "photo" varchar, "phone" varchar, "city" varchar, "region" varchar, "role" varchar CHECK( "role" IN ('agent','director') ) NOT NULL DEFAULT ('agent'), "telegramId" varchar, "agencyId" integer, CONSTRAINT "UQ_e12875dfb3b1d92d7d7c5377e22" UNIQUE ("email"), CONSTRAINT "FK_ffe98999bc6a1edce7af102f74c" FOREIGN KEY ("agencyId") REFERENCES "agency" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION)`);
        ...
        await queryRunner.query(`CREATE TABLE "temporary_selections" ("id" SERIAL PRIMARY KEY NOT NULL, "title" varchar NOT NULL, "propertyIds" text NOT NULL, "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "userId" integer, CONSTRAINT "FK_8a067bad8ee4a8e699449aa0e2b" FOREIGN KEY ("userId") REFERENCES "user" ("id") ON DELETE CASCADE ON UPDATE NO ACTION)`);
        ...
        await queryRunner.query(`CREATE TABLE "temporary_calendar_events" ("id" SERIAL PRIMARY KEY NOT NULL, "title" varchar NOT NULL, "description" text, "start" datetime NOT NULL, "end" datetime, "type" varchar NOT NULL DEFAULT ('personal'), "userId" integer, "relatedObjectId" integer, "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "updatedAt" datetime NOT NULL DEFAULT (datetime('now')), CONSTRAINT "FK_1c7bc3511809b48395c3eec5484" FOREIGN KEY ("userId") REFERENCES "user" ("id") ON DELETE CASCADE ON UPDATE NO ACTION)`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "user" ("id" SERIAL PRIMARY KEY NOT NULL, "email" varchar NOT NULL, "password" varchar NOT NULL, "firstName" varchar NOT NULL, "lastName" varchar NOT NULL, "photo" varchar, "phone" varchar, "city" varchar, "region" varchar, "role" varchar CHECK( "role" IN ('agent','director') ) NOT NULL DEFAULT ('agent'), "telegramId" varchar, "agencyId" integer, CONSTRAINT "UQ_e12875dfb3b1d92d7d7c5377e22" UNIQUE ("email"), CONSTRAINT "FK_ffe98999bc6a1edce7af102f74c" FOREIGN KEY ("agencyId") REFERENCES "agency" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION)`);
        ...
        await queryRunner.query(`CREATE TABLE "client" ("id" SERIAL PRIMARY KEY NOT NULL, "name" varchar NOT NULL, "email" varchar NOT NULL, "phone" varchar NOT NULL, "status" varchar CHECK( "status" IN ('new','negotiation','contract','deposit','success','refused') ) NOT NULL DEFAULT ('new'), "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "updatedAt" datetime NOT NULL DEFAULT (datetime('now')), "agentId" integer, CONSTRAINT "UQ_6436cc6b79593760b9ef921ef12" UNIQUE ("email"))`);
        ...
        await queryRunner.query(`CREATE TABLE "property" ("id" SERIAL PRIMARY KEY NOT NULL, "title" varchar NOT NULL, "description" text NOT NULL, "address" varchar NOT NULL, "price" decimal NOT NULL, "area" float NOT NULL, "bedrooms" integer NOT NULL, "bathrooms" integer NOT NULL, "status" varchar CHECK( "status" IN ('for_sale','in_deal','reserved','sold') ) NOT NULL DEFAULT ('for_sale'), "isExclusive" boolean NOT NULL DEFAULT (0), "photos" text, "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "lat" float, "lng" float, "agentId" integer)`);
