...
export class NotificationCategory1750843021814 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "temporary_notifications" ("id" SERIAL PRIMARY KEY NOT NULL, "userId" integer NOT NULL, "type" varchar NOT NULL DEFAULT ('info'), "title" varchar NOT NULL, "description" varchar, "isNew" boolean NOT NULL DEFAULT (1), "createdAt" datetime NOT NULL DEFAULT (CURRENT_TIMESTAMP), "category" varchar NOT NULL DEFAULT ('property'))`);
